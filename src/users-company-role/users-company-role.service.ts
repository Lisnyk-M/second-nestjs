...
export class UsersCompanyRoleService {
  constructor(
    ...
    private usersCompanyRoleRepository: Repository<UsersCompanyRole>, // @InjectRepository(Companys) // private companysService: CompanysService, // // @InjectRepository(Role) // private roleServise: RoleService, // // @InjectRepository(User) // private userService: UsersService,
  ) {}
  ...
  async addRole(
    ...
    // }
    //
    // const getedCompany = await this.userService.getUserCompany(
    //   companyId,
    //   userId,
    // );
    ...
    //     `user with Id: ${userId} not found in company with Id: ${companyId} `,
    ...
    // if (findRoleUCR) {
    //   throw new HttpException(
    //     `role with id: ${roleId} already exist in user with id: ${userId}`,
    //     HttpStatus.CONFLICT,
    //   );
    // }
    //
